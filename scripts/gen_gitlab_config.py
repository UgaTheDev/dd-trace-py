    ...
    if pr_matches_patterns(
        {
            ...
            ".readthedocs.yml",
            ".uv/build-docs--build-docs-py310-*.txt",
        }
    ):
        ...
        with TESTS_GEN.open("a") as f:
            ...
            print(
                "      DD_TRACE_ENABLED=false uv run --no-project --python 3.10 --no-python-downloads "
                "--with-editable . --with-requirements .uv/build-docs--build-docs-py310-*.txt scripts/docs/build.sh",
                file=f,
            )
